...
namespace Asp.netApp.Areas.Admin.ViewComponents.AttributeOption
{
    public class AttributeOptionViewComponent:ViewComponent
    {
        private readonly ApplicationDbContext _context;
        public AttributeOptionViewComponent(ApplicationDbContext context)
        {
            _context = context;
        }
